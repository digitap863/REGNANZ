  ...
  <body>
      ...
      <nav class="navbar navbar-static-top navbar-expand-lg px-3 px-md-5">
        <div class="container-fluid position-relative px-0">
          ...
          <a class="navbar-brand" href="index.html">
            <img class="img-log" src="images/regn-black.png" alt="logo">
          </a>
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <!-- <li class="dropdown nav-item">
                <a class="nav-link" href="javascript:void(0)" data-bs-toggle="dropdown">Pa<i class="fas fa-chevron-down fa-xs"></i></a>
                    ...
                    <div class="row g-0">
                      <div class="col-sm-6 col-md-4">
                        ...
                        <ul class="list-unstyled mt-lg-1">
                          ...
                          <li class="active"><a class="dropdown-item" href="contact-us.html"><span>Contact us</span></a></li>
    ...
    <section class="space-ptb">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-9">
            <form class="row fill-form mb-4 mb-md-0 form-flat-style" action="send-mail.php" method="post">
          ...
          <div class="col-md-3">
            ...
            <p class="mb-2">Regnanz Education,<br>2nd Floor, Cental Arcade.<br>
              Cherooty Road,<br>Calicut - 673032</p>
            <p class="mb-2"><b class="text-dark">Call us:</b>  9656 300 567,9037 206 760</p>
            <p class="mb-4"><b class="text-dark">Mail us:</b>  admissions@regnanzedu.co.in,<br>admin@regnanzedu.co.in</p>
            ...
            <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
              <div class="footer-contact-info">
                ...
                <div class="contact-address">
                  ...
                  <div class="contact-item mb-3 mb-md-4">
                    <h4 class="mb-0 fw-normal"><a href="#">9656 300 567<br>9037 206 760</a></h4>
                  </div>
                  <div class="contact-item">
                    <a href="#">admissions@regnanzedu.co.in<br>admin@regnanzedu.co.in</a>
                  </div>
                </div>
              </div>
            </div>
